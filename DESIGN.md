...
- Provider handling is intentionally small: Anthropic and Ollama expose the same internal message path, while Ollama uses its native HTTP API to avoid a second provider dependency.
